...
function Navbar() {
  ...
  return (
    <>              { /* tailwind navbar */}
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0  dark:bg-slate-800 dark:text-white z-50
      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl font-bold cursor-pointer">NandBookShop</a>
          </div>
          ...
          <div className="hidden md:block">
            <label className="x px-3 py-2 border rounded-md flex items-center gap-2">
                <input type="text" className="grow outline-none rounded-md px-1" placeholder="Search" />
